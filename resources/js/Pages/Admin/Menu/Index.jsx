                                    ...
                                    <tr key={item.id} className="hover:bg-white/5 transition-colors group">
                                        ...
                                        <td className="px-8 py-5 text-right space-x-4">
                                            ...
                                            <button
                                                ...
                                                className="px-4 py-2 text-[10px] font-bold text-rose-400 border border-rose-400/20 hover:bg-rose-500 hover:text-white uppercase tracking-widest transition-all rounded-lg"
                                            >
                                                Supprimer
                                            </button>
                                        </td>
